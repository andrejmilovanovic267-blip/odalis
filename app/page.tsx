  ...
  return (
    <main className="relative z-10">
      ...
      <Section className="relative">
        <div className="absolute inset-0 bg-gradient-to-b from-navy-800/40 via-transparent to-transparent pointer-events-none" />
      ...
      <Section className="relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-text-muted text-center text-lg md:text-xl mt-8">
      ...
      <Section className="relative">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-navy-800/50 to-transparent pointer-events-none" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <div className="space-y-8">
              <article>
                <h3 className="text-text-primary text-xl md:text-2xl font-semibold mb-4">
